...
const actions = {
     ...
     * @return {Promise}
     */
    async fetchDatasetThumbnail({commit}, {datasetId}) {

        // TODO
        console.log(`[FETCH] /collection/dataset/${datasetId}/thumbnail`);
        ...
        commit("SET_DATASET_THUMBNAIL_DATA_URL", {datasetId, dataUrl});
    }
}
...
const mutations = {
    ...
    SET_DATASET_THUMBNAIL_DATA_URL(state, {datasetId, dataUrl}) {
        state.datasetMap = {
            ...state.datasetMap,
            [datasetId]: {
                ...state.datasetMap[datasetId],
...
const getters = {
     ...
     * @param state
     * @param getters
     * @return {getDatasetThumbnailDataUrlCallback}
     */
    getDatasetThumbnailDataUrl: (state, getters) => {
        ...
        return ({datasetId}) => {
            ...
            if (dataset.thumbnailDataUrl) {
                return dataset.thumbnailDataUrl;
            } else {
                return null;
            }
        }
