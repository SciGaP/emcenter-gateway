            ...
            <b-tr v-for="(resource) in resources" :key="resource.resourceId" :class="{selected: false}">
              ...
              <b-td>
                <div style="flex: 1;">
                  ...
                  <router-link v-else-if="resource.type === 'COLLECTION_GROUP'"
                               :to="`/collection-groups?parentResourceId=${resource.resourceId}`"
                  ...
                  <router-link v-else-if="resource.type === 'COLLECTION'"
