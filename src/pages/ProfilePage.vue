    ...
    <b-overlay :show="processing">
      <div class="p-2" style="display: flex; flex-direction: row;">
        ...
        <div style="flex: 1;padding-left: 10px;">
          ...
          <!--                Add new attribute-->
          <!--              </b-button>-->
          <!--              &lt;!&ndash;              <ul v-if="attributes.length > 0" class="list-inline d-inline-block mb-2">&ndash;&gt;-->
          <!--              &lt;!&ndash;                <li v-for="(attribute, attributesIndex) in attributes" :key="attributesIndex" class="list-inline-item">&ndash;&gt;-->
          <!--              &lt;!&ndash;                  <b-form-tag variant="primary" :title="`${attribute.key} = ${attribute.values}`">&ndash;&gt;-->
          <!--              &lt;!&ndash;                    <div style="display: flex; flex-direction: row;">&ndash;&gt;-->
          <!--              &lt;!&ndash;                      <label :for="`attributes-${attributesIndex}`">{{ attribute.key }} =</label>&ndash;&gt;-->
          <!--              &lt;!&ndash;                      <b-form-input :id="`attributes-${attributesIndex}`" v-model="attribute.values"/>&ndash;&gt;-->
          <!--              &lt;!&ndash;                    </div>&ndash;&gt;-->
          <!--              &lt;!&ndash;                  </b-form-tag>&ndash;&gt;-->
          <!--              &lt;!&ndash;                </li>&ndash;&gt;-->
          <!--              &lt;!&ndash;              </ul>&ndash;&gt;-->
          <!--            </table-overlay-info>-->
          <!--          </div>-->
...
} from "airavata-custos-portal/src/components/validation-regex";
